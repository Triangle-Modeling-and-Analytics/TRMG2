...
The calibration targets were developed based on the mode split from the NCSU survey and use the four modes of the model: walk, bicycle, transit and auto. The relatively large targets for transit for Campus-to-campus and Home-Campus trips contribute positively to the transit ridership forecast.
