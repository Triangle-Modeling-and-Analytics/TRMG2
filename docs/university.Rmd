...
The figure below compares the distance distribution of NCSU Home-Campus trips. The simulated cumulative average trip length is slightly off when compared with the observed data. The trip length disparity is almost certainly due to how we were forced to come up with off-campus housing: by restricting it to address points within 10 miles. (see: https://caliper-corporation.github.io/TRMG2/tazs_and_se_data.html#Student_housing_(off-campus)) 

![](university_files/university-summary-figures/university_home_to_campus_dist_distribution.png)


#### Average Trip Length
When looked at by mode, the average trip length compares extremely well for simulated versus observed data for NCSU.
