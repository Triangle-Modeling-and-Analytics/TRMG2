...
Initial estimation attempts led to poor model results. A fundamental problem
may have been regressing a 2010 survey against 2016 land use data. In addition,
stakeholders had previously listed some concerns with the survey. Given these
issues, initial rates were adapted directly from the QRFM.
