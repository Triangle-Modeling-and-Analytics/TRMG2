...
market in the Triangle, the household survey does not contain enough transit
trips to estimate the behavior of these travelers.
...
routes were collected in each survey, no adjustments to the weights were needed.
