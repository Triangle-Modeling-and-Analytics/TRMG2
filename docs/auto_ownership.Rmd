...
likely to own multiple. This adds another dimension of model sensitivity to
transit investments. New transit routes will affect long-term household
decisions about auto ownership, which further influence their decisions about
daily mode choices.

Looking in more detail, the trend for coefficients across alternatives is also
intuitive. Many workers in a household has a small positive impact on the
