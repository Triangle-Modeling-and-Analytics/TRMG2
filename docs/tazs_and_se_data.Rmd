...
below shows the count of block groups by percent children and seniors. A minimum
percentage was asserted for both children and seniors at 2.5%. This prevents
TAZs with 1,000 or more household population from having unrealistically low
levels of children and seniors (the ACS is a survey, not a full enumeration).
