...
residents, this stratification is informed by the household incomes at the
origin and destination as well as by the length of the trip.
...
shows a large disparity between the peaks driven largely by non-work travel.
