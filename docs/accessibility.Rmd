...
Accessibility is the ability of travelers to reach locations where they can
...
a trip from this location, perhaps for a particular purpose, by a particular
...
make more trips, because they are shorter on average, and so they can accomplish
...
scales residents' willingness to travel (senstivity to travel time) because when
a person chooses their residence locaiton, they are also choosing how far they
are generally willing to travel.  The accessibilty of destinations is also a 
...
with many dead ends, cul-de-sacs, and three-way intersections. To caluclate this
...
the logsums used for these accessibility measures is based on a simpler gravity
