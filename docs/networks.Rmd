...
The TRMG2 does not predict transponder ownership, but instead has parameters
that can be modified during scenario testing. For the base year, the parameters
were calculated using data obtained from NC Turnpike Authority. These allowed
