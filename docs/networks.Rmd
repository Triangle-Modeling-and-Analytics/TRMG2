...
The listed prices were used to come up with an average cost per mile of $0.21.

```{r}
# note: price is .32/mile for those without transponders. Weighting on
# turnpike to provide a breakdown of transponder use.
```
