...
being shorter and more condensed than the PM. Travelers have much more
flexibility in their travel choices in the PM.
...
work_trips <- tripTbl %>%
  mutate(
    work_trip = ifelse(
      tour_type == "WT", #& homebased == "HB" & purp_scheme == "W",
...
and all trips are exactly the same.
