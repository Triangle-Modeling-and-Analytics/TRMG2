...
##### Mode
For respondents who reported multiple modes, Mode_1 was assumed to be the primary mode. The survey includes  Drive and car passenger are combined into a single mode named car. 
...
NCSUtemp_df<- NCSU_All_df %>% 
  ...
  mutate(
    ...
    Bus = if_else(Primary_Mode == "Public Bus / Private Shuttle" | "Other, wolfline",1,0),
    ...
    Other = if_else(Primary_Mode == "Other" | Primary_Mode == "Other, Longboard" | Primary_Mode == "Other"))
