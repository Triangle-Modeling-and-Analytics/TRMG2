...
table below provides a sample of these metrics for one of the classification
schemes tested.

**TODO: Update this with the final scheme when selected**
...
scheme1 <- prep_for_eda %>%
  mutate(
    ...
    purp_scheme = case_when(
      ...
      o_activity %in% c("POS", "DOS") ~ "EK12",
      a_activity %in% c("POS", "DOS") ~ "EK12",
