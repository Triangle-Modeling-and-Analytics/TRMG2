...
dBox "Merge" (Args) location: x, y, , 15
    ...
    button 22, same, 10 Prompt:"Help" do
        ShowMessage(
            "The master link layer is managed jointly by TWTPO MPO and CAMPO. " +
...
Macro "test merge"
    merge = CreateObject("MergeTool", {
        ...
        NewDBD: "C:\\projects\\TRM\\trm_project\\working_files\\client_data\\2020\\TWTPO_data\\master_links.dbd",
        PolyDBD: "C:\\projects\\TRM\\trm_project\\working_files\\client_data\\2020\\TWTPO_data\\TWTPO_poly.dbd"
    })
    merge.Replace()
endmacro
