...
Macro "MOVES" (Args, region, year)
  ...
  */
  ...
  speed.mutate("AvgSpeedFraction", if speed.tbl.dayID <>2 then nz(speed.tbl.Fraction) else nz(speed.tbl.DefaultFraction)) // weekend fraction should be set to default
