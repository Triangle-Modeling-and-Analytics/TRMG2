...
dBox "Transit Poverty HH Coverage" (Args) location: center, center, 80, 20
  ...
  init do
    ...
    static BG_Layer_DBD, Census_Poverty_Data_Dir
  ...
  text same, after, 40 variable: BG_Layer_DBD framed
  button after, same, 6 Prompt: "..." do

    on escape goto nodir
    BG_Layer_DBD = ChooseFile({{"DBD", "*.dbd"}}, "Choose the Block Group Geographical File", )
  ...
  button after, same, 6 Prompt: "..." do
    ...
    on escape goto nodir
    Census_Poverty_Data_Dir = ChooseFile({{"CSV", "*.CSV"}}, "Choose the Census Poverty Data File", )
  ...
  button 40, 18, 30 Prompt:"Generate Transit Coverage" do // button p1,p2,p3, p1 horizontal, p2 vertical, p3 length
    ...
    else if UseStop = 1 then RunMacro("Poverty_HH_Estimator_Stop", Args, BG_Layer_DBD, Census_Poverty_Data_Dir, TOD, StopBuffer) 
		
    if UseRoute = 1 and (RouteBuffer = null or TOD = null) then ShowMessage("Please make a selection for all drop down lists.")
    else if UseRoute = 1 then RunMacro("Poverty_HH_Estimator_Route",  Args, BG_Layer_DBD, Census_Poverty_Data_Dir, TOD, RouteBuffer)
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
Macro "Poverty_HH_Estimator_Route" (Args, BG_Layer_DBD, Census_Poverty_Data_Dir, TOD, RouteBuffer)
  ...
  {bglyr} = GetDBLayers(BG_Layer_DBD)
  bglyr = AddLayer(map, bglyr, BG_Layer_DBD, bglyr)
  SetLayer(bglyr)
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
Macro "Poverty_HH_Estimator_Stop" (Args, BG_Layer_DBD, Census_Poverty_Data_Dir, TOD, StopBuffer)
