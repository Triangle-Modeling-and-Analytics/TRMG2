...
campo_sl_filename <- paste0(external_dir, "streetlight/161428_TRM20test5_2016/161428_TRM20test5_2016_od_all.csv")
durham_sl_filename <- paste0(external_dir, "streetlight/164792_TRM20_2016_All/164792_TRM20_2016_All_od_all.csv")

output_clean_streetlight_filename <- paste0(interim_dir, "clean-streetlight.rds")
```
